...
| **Heritage Purple** | `#431846` | `--color-heritage-purple` |
| **Heritage Red** | `#ed1c24` | `--color-heritage-red` |

**Color Notes:** Premium black + gold accent, with Heritage Purple for depth and Heritage Red for signature micro-details.
